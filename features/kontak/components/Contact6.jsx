      ...
      <div className="container grid grid-cols-1 items-start gap-y-12 md:grid-flow-row md:grid-cols-2 md:gap-x-12 lg:grid-flow-col lg:gap-x-20 lg:gap-y-16">
        <div>
          <div className="mb-6 md:mb-8">
            <p className="mb-3 font-semibold md:mb-4">Tulis</p>
            <h2 className="heading-h2 mb-5 font-bold md:mb-6">Formulir kami</h2>
            <p className="text-medium">Lengkapi data diri dan pesan anda</p>
          </div>
          <div className="grid grid-cols-1 gap-4 py-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <p>Jalan Tanjungsari, Jakarta Selatan 12520</p>
            </div>
          </div>
        </div>
        <form className="grid max-w-lg grid-cols-1 grid-rows-[auto_auto] gap-6">
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            <Label className="mb-3 md:mb-4">Siapa anda di kampus</Label>
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Mahasiswa aktif" id="#first_choice" />
                <Label htmlFor="#first_choice">Mahasiswa aktif</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Dosen pengajar</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Tenaga kependidikan</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Alumni universitas</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Masyarakat umum</Label>
              </div>
              <div className="flex items-center space-x-2">
