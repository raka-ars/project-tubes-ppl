          ...
          <Card className="flex size-full flex-col items-center justify-start">
            ...
            <div className="px-5 py-6 md:p-6">
              <div className="mb-4 flex w-full items-center justify-start">
                ...
                <p className="text-small inline font-semibold">7 menit baca</p>
              </div>
              ...
              <p>
                Prestasi gemilang dalam kompetisi penelitian global tahun ini
              </p>
              <Button
                variant="link"
                size="link"
          ...
          <Card className="flex size-full flex-col items-center justify-start">
            ...
            <div className="px-5 py-6 md:p-6">
              <div className="mb-4 flex w-full items-center justify-start">
                ...
                <p className="text-small inline font-semibold">5 menit baca</p>
              </div>
              <a className="mb-2 block" href="#">
                <h2 className="heading-h5 font-bold">
              ...
              <p>
                Inisiatif pengembangan karakter untuk generasi pemimpin masa
                depan
              </p>
              <Button
                variant="link"
