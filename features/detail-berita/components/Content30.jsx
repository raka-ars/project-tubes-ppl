        ...
        <div className="mx-auto max-w-lg">
          ...
          <div>
            <div className="mb-8 text-center md:mb-10 lg:mb-12">
              <p className="text-medium font-semibold">Bagikan artikel ini</p>
            ...
            <div>
              <div className="flex flex-wrap justify-center gap-2">
                <Badge className="border-none">
                  <a href="#">Pembelajaran digital</a>
                </Badge>
                <Badge className="border-none">
                  <a href="#">Inovasi kampus</a>
                </Badge>
                <Badge className="border-none">
                  <a href="#">Teknologi pendidikan</a>
                </Badge>
                <Badge className="border-none">
                  <a href="#">Pengembangan akademik</a>
                </Badge>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="grow">
              <p className="text-medium font-semibold">Rini Handayani</p>
              <p>Jurnalis senior, TEL-U News</p>
            </div>
          </div>
        </div>
      </div>
